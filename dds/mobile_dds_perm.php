<?php
				...
				if (in_array ($ip, $deny)) {
			   header("location: mobile_dds_per_m.php");
			   exit();}
			   ?>
...
mysql_query("INSERT INTO dds_req_perm VALUES ('', '$temp_name', '$email', '$phone ', '$notes', '$need_id', DATE_ADD(NOW(), INTERVAL 1 HOUR),'$ipaddress','new' ) "); 

					require("email_dds_perm.php");

									$i = 0;
									
								$query = mysql_query("select * from dds_perm_need WHERE active = 'Y' ORDER BY office_location "); 
															 ...
															 ?>
																...
																<td>  <FORM action="my_ajax_receiver_perm_mobile.php" method="post">
																  ...
																  <?php 
																						...
																						echo"<script>
																								setTimeout(function(){
																								window.location.replace('mobile_dds_perm.php');
																								}, 3000);
																								</script>";
