<?php	
				...
				if (in_array ($ip, $deny)) {
			   header("location: mobile_dh_tem_p.php");
			   exit();}
...
<h2>Temporary opportunities for Hygienists <br>
	<a id="mob_link_itself" href ="mobile_dh_perm.php">click here for Permanent assignments</a> 
</h2>

	
	
<p id="para_temp">Please click the "request" button for details on each assignment.</p>
															 ...
															 ?>
																...
																<td>  <FORM action="my_ajax_receiver_mobile.php" method="post">
																  ...
																  <?php 
																						...
																						echo"<script>
																								setTimeout(function(){
																								window.location.replace('mobile_dh_temp.php');
																								}, 3000);
																								</script>";
