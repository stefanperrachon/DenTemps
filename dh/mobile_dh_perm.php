<?php
				...
				if (in_array ($ip, $deny)) {
			   header("location: mobile_dh_per_m.php");
			   exit();}
			   ?>
...
<h2>Permanent opportunities for Hygienists <br>
	<a id="mob_link_itself" href ="mobile_dh_temp.php">click here for Temporary assignments</a> 
</h2>
...
mysql_query("INSERT INTO dh_req_perm VALUES ('', '$temp_name', '$email', '$phone ', '$notes', '$need_id', DATE_ADD(NOW(), INTERVAL 1 HOUR),'$ipaddress','new' ) "); 

					require("email_dh_perm.php");
															 ...
															 ?>
																...
																<td>  <FORM action="my_ajax_receiver_perm_mobile.php" method="post">
																  ...
																  <?php 
																						...
																						echo"<script>
																								setTimeout(function(){
																								window.location.replace('mobile_dh_perm.php');
																								}, 3000);
																								</script>";
