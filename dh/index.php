...
<div id="back_form">
	<h1>DenTemps</h1>
		...
		<div id="temp_pos_switch" class="temp_links"><a href="dh_perm.php">Permanent Assignments</a></div>

		</div>
	</div>

<h2>Temporary opportunities for Hygienists</h2>
...
<div id="tab_div">
<?php	
	include ("dh_mobile_dectection.php");
