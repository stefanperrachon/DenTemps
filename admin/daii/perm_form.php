...
<div id="back_form">
	<div id="pos">Perm Needs for DAII</div>
...
<div id="link_resize">
				<div class="temp_links_admin"><a class="a_class" href="index.php">DAII Temp</a></div>
				<div class="temp_links_admin" id="temp_pos_switch" class="temp_links"><a id="present_link" href="perm_form.php">DAII Perm</a></div>
