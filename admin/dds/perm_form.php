...
<div id="back_form">
	<div id="pos">Perm Needs for DDS</div>
...
<div id="link_resize">
				...
				<div class="temp_links_admin"><a class="a_class" href="index.php">DDS Temp</a></div>
				<div class="temp_links_admin" id="temp_pos_switch" class="temp_links"><a id="present_link" href="perm_form.php">DDS Perm</a></div>
