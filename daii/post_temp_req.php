...
mysql_query("INSERT INTO daii_req_temp VALUES ('', '$temp_name', '$email', '$phone ', '$notes', '$need_id', DATE_ADD(NOW(), INTERVAL 1 HOUR),'$ipaddress','new' ) "); 

	$query = mysql_query("select * from daii_temp_need WHERE id = '$need_id'");  // change table name for duplicate
...
// mail to dt
$DT_sub = $temp_name.", DAII requests ".$date." in ".$office;
