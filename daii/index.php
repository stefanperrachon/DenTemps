...
<div id="back_form">
	<h1>DenTemps</h1>
		...
		<div id="temp_pos_switch" class="temp_links"><a href="daii_perm.php">Permanent Assignments</a></div>

		</div>
	</div>

<h2>Temporary opportunities for Dental Assistants</h2>
...
include ("daii_mobile_dectection.php");
