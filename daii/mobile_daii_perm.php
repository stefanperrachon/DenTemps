<?php
				...
				if (in_array ($ip, $deny)) {
			   header("location: mobile_daii_per_m.php");
			   exit();}
			   ?>
<!DOCTYPE html>
<html lang="en">
...
<h2>Permanent opportunities for Dental Assistants <br>
...
mysql_query("INSERT INTO daii_req_perm VALUES ('', '$temp_name', '$email', '$phone ', '$notes', '$need_id', DATE_ADD(NOW(), INTERVAL 1 HOUR),'$ipaddress','new' ) "); //VERSION 6

					require("email_da_perm.php");

									$i = 0;
									
								$query = mysql_query("select * from daii_perm_need WHERE active = 'Y' ORDER BY office_location "); 
															 ...
															 ?>
																...
																<td>  <FORM action="my_ajax_receiver_perm_mobile.php" method="post">
																  ...
																  <?php 
																						...
																						echo"<script>
																								setTimeout(function(){
																								window.location.replace('mobile_daii_perm.php');
																								}, 3000);
																								</script>";
