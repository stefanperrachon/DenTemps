<?php	
				...
				if (in_array ($ip, $deny)) {
			   header("location: mobile_daii_tem_p.php");
			   exit();}
...
mysql_query("INSERT INTO daii_req_temp VALUES ('', '$temp_name', '$email', '$phone ', '$notes', '$need_id', DATE_ADD(NOW(), INTERVAL 1 HOUR),'$ipaddress','new' ) ");  //VERSION 6

					require("email_da_temp.php");
															 ...
															 ?>
																...
																<td>  <FORM action="my_ajax_receiver_mobile.php" method="post">
																  ...
																  <?php 
																						...
																						echo"<script>
																								setTimeout(function(){
																								window.location.replace('mobile_daii_temp.php');
																								}, 3000);
																								</script>";
