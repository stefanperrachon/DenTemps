<?php
				...
				if (in_array ($ip, $deny)) {
			   header("location: mobile_fd_per_m.php");
			   exit();}
			   ?>
<!DOCTYPE html>
<html lang="en">
...
<h2>Permanent opportunities for Front Desk Office Managers <br>
	<!--<a id="mob_link_itself" href ="mobile_daii_temp.php">click here for Temporary assignments</a> -->
</h2>
...
mysql_query("INSERT INTO fd_req_perm VALUES ('', '$temp_name', '$email', '$phone ', '$notes', '$need_id', DATE_ADD(NOW(), INTERVAL 1 HOUR),'$ipaddress','new' ) "); 

					require("email_fd_perm.php");

									$i = 0;
									
								$query = mysql_query("select * from fd_perm_need WHERE active = 'Y' ORDER BY office_location "); 
										   ...
										   else 
										  {
											...
											$i++;					
															 ...
															 ?>
																...
																<td>  <FORM action="my_ajax_receiver_perm_mobile.php" method="post">
																  ...
																  <?php 
																						...
																						echo"<script>
																								setTimeout(function(){
																								window.location.replace('mobile_fd_perm.php');
																								}, 3000);
																								</script>";
...
<div id="link_resize">
		...
		<div class="temp_links"><a href="http://dentempsnc.com/mobile/fd_paperwork.html">List of Paperwork</a></div>
