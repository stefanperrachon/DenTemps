...
<h2>Permanent opportunities for Front Desk Office Managers</h2>
...
<div id="tab_div">
<?php	
	include ("fd_mobile_dectection_perm.php");
			   ...
			   echo"<script>window.location.replace('fd_per_m.php')</script>";
			   exit();}
